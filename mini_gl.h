...
#define GL_LIST \
    ...
    GLE(void,      GetProgramInfoLog,       GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog) \
...
{
    #define GLE(ret, name, ...)                                                                    \
            gl##name = (name##proc *)glfwGetProcAddress("gl" #name);                                \
            if (!gl##name) {                                                                       \
